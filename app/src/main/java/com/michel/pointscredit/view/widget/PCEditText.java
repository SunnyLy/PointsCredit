...
public class PCEditText extends RelativeLayout {
    ...
    public PCEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        View contentView = LayoutInflater.from(context).inflate(R.layout.widget_login_edittext, null);
    ...
    private void initView(View view) {
        mEdiText = view.findViewById(R.id.widget_et_content);
        mETIcon = view.findViewById(R.id.widget_et_ic);
